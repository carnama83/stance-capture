...
// ✅ NEW: gate debug-only panel so missing views don't break Live Questions in prod
const ENABLE_TRENDING_DEBUG =
  import.meta.env.VITE_ENABLE_TRENDING_DEBUG === "true";
  ...
  return (
    <Card className="max-w-6xl mx-auto">
      ...
      <CardContent className="space-y-3">
        ...
        {/* ✅ Admin-only trending debug (gated to avoid vw_topics_trending errors in prod) */}
        {ENABLE_TRENDING_DEBUG && <AdminTrendingDebugPanel />}
      </CardContent>
    </Card>
  );
}
