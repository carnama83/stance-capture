              ...
              rows.map((r) => (
                <tr key={r.id} className="border-t [&>td]:px-3 [&>td]:py-2">
                  ...
                  <td>
                    <button
                      type="button"
                      className="inline-flex items-center rounded border px-2 py-1 text-xs font-medium disabled:opacity-60"
                      onClick={() => handleCreateTopicDraft(r.id)}
                      disabled={creatingDraftId === r.id}
                    >
                      {creatingDraftId === r.id
                        ? "Creating…"
                        : "Create topic draft"}
                    </button>
                  </td>
