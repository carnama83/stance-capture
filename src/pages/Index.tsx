...
// ---- Comments types & mocks (place near other types/mocks) ----
type Comment = {
  id: string;
...
const MOCK_COMMENTS: Record<string, Comment[]> = {
  // example: "t1": [{ id:"c1", parent_id:null, topic_id:"t1", user_display:"User", body:"Hello", created_at:new Date().toISOString() }]
};

// ---- Data adapter (canonical: comments) ----
...
// ---- Nested preview component (depth-2) ----
