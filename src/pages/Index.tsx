...
import { InlineQuestionStanceEditor } from "@/components/question/InlineQuestionStanceEditor";
import { TodayQuestionsFeed } from "@/components/Question/TodayQuestionsFeed";
  ...
  return (
    <PageLayout rightSlot={actions}>
      ...
      <section className="py-4">
        ...
        {/* 🔹 New: Today’s curated questions (Epic P) */}
        <div className="mb-4">
          <TodayQuestionsFeed
            limit={7}
        ...
        {/* Existing: Latest questions / tailored feed */}
        <LatestQuestions
            ...
            >
              <div className="flex items-start justify_between gap-3">
                ...
                <div className="flex flex-col items-end gap-1 shrink-0">
                  ...
                  />
                  {isAuthed && (
                    <InlineQuestionStanceEditor questionId={q.id} />
                  )}
                </div>
              </div>
            </div>
