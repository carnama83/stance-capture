  ...
  return (
    <div className="w-full space-y-3">
      ...
      >
        ...
        >
          {/* -2 */}
          <span className="max-w-[130px] leading-tight shrink-0 overflow-hidden line-clamp-4 break-words text-sm">
            {stanceLabels[-2]}
          </span>
          ...
          {/* +2 */}
          <span className="max-w-[130px] text-right leading-tight shrink-0 overflow-hidden line-clamp-4 break-words text-sm">
            {stanceLabels[2]}
          </span>
        </div>
